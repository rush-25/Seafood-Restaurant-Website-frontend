...
const navItems = [
  ...
  { id: "reservations" as Page, label: "Reservations", icon: CalendarRange },
  { id: "messages" as Page, label: "Emails / Messages", icon: Mail },
];
    ...
    <aside className="flex flex-col h-full w-64 flex-shrink-0" style={{ background: "#120b04", borderRight: "1px solid rgba(201,144,106,0.14)" }}>
      ...
      <div className="px-4 pb-6">
        ...
        <button
          ...
          style={{ color: "#5a3a20" }}
          onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.color = "#e85555"; (e.currentTarget as HTMLElement).style.background = "rgba(200,60,60,0.08)"; }}
          onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.color = "#5a3a20"; (e.currentTarget as HTMLElement).style.background = "transparent"; }}
        >
