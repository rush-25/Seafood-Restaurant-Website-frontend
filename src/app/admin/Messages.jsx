              ...
              <tbody>
                ...
                {filtered.map((m, i) => (
                  <tr
                    ...
                    onMouseEnter={(e) => { if (selectedId !== m.id) e.currentTarget.style.background = "rgba(107,61,30,0.02)"; }}
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          style={{ color: "#c9b09a" }}
                          onMouseEnter={(e) => { e.currentTarget.style.color = "#6b3d1e"; e.currentTarget.style.background = "rgba(107,61,30,0.07)"; }}
                          onMouseLeave={(e) => { e.currentTarget.style.color = "#c9b09a"; e.currentTarget.style.background = "transparent"; }}
                          title="View"
                        >
                          <Eye size={16} />
                        </button>
                        <button
                          ...
                          className="p-1.5 rounded-lg transition-colors"
                          style={{ color: "#c9b09a" }}
                          onMouseEnter={(e) => { e.currentTarget.style.color = "#c0392b"; e.currentTarget.style.background = "rgba(192,57,43,0.07)"; }}
                          onMouseLeave={(e) => { e.currentTarget.style.color = "#c9b09a"; e.currentTarget.style.background = "transparent"; }}
                          title="Delete"
                        >
                          <Trash2 size={16} />
